...
export class InvitationService {
   ...
   * 
   */
  public async sendInvitation(notification: Notification): Promise<Notification> {
    ...
    const invitation = new Invitation(notification);
    await this.notificationsService.send(invitation);
    return notification;
  }
  /**
   * 
