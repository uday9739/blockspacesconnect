...
export class InitWalletRequest extends jspb.Message { 
    ...
    setChannelBackups(value?: lightning_pb.ChanBackupSnapshot): InitWalletRequest;
    getStatelessInit(): boolean;
    setStatelessInit(value: boolean): InitWalletRequest;
    getExtendedMasterKey(): string;
    setExtendedMasterKey(value: string): InitWalletRequest;
    getExtendedMasterKeyBirthdayTimestamp(): number;
    setExtendedMasterKeyBirthdayTimestamp(value: number): InitWalletRequest;

    hasWatchOnly(): boolean;
    clearWatchOnly(): void;
    getWatchOnly(): WatchOnly | undefined;
    setWatchOnly(value?: WatchOnly): InitWalletRequest;
...
export class InitWalletResponse extends jspb.Message { 
    ...
    setAdminMacaroon(value: Uint8Array | string): InitWalletResponse;
...
export class WatchOnly extends jspb.Message { 
    ...
    setMasterKeyBirthdayTimestamp(value: number): WatchOnly;
    getMasterKeyFingerprint(): Uint8Array | string;
    getMasterKeyFingerprint_asU8(): Uint8Array;
    getMasterKeyFingerprint_asB64(): string;
    setMasterKeyFingerprint(value: Uint8Array | string): WatchOnly;
    clearAccountsList(): void;
    getAccountsList(): Array<WatchOnlyAccount>;
    setAccountsList(value: Array<WatchOnlyAccount>): WatchOnly;
...
export class WatchOnlyAccount extends jspb.Message { 
    getPurpose(): number;
    setPurpose(value: number): WatchOnlyAccount;
    getCoinType(): number;
    setCoinType(value: number): WatchOnlyAccount;
    getAccount(): number;
    setAccount(value: number): WatchOnlyAccount;
    getXpub(): string;
    setXpub(value: string): WatchOnlyAccount;
...
export class UnlockWalletRequest extends jspb.Message { 
    ...
    clearChannelBackups(): void;
    getChannelBackups(): lightning_pb.ChanBackupSnapshot | undefined;
    setChannelBackups(value?: lightning_pb.ChanBackupSnapshot): UnlockWalletRequest;
    getStatelessInit(): boolean;
    setStatelessInit(value: boolean): UnlockWalletRequest;
...
export class ChangePasswordRequest extends jspb.Message { 
    ...
    getStatelessInit(): boolean;
    setStatelessInit(value: boolean): ChangePasswordRequest;
    getNewMacaroonRootKey(): boolean;
    setNewMacaroonRootKey(value: boolean): ChangePasswordRequest;
...
export class ChangePasswordResponse extends jspb.Message { 
    ...
    getAdminMacaroon_asU8(): Uint8Array;
    getAdminMacaroon_asB64(): string;
    setAdminMacaroon(value: Uint8Array | string): ChangePasswordResponse;
